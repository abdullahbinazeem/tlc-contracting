          ...
          {serviceList.map((service) => (
            <a className="" href="#">
              <div className="relative h-[400px] md:h-[500px] overflow-hidden rounded-xl group">
                ...
                <div className="absolute group-hover:bottom-10 bottom-[-25px] transition-all left-10 z-20 duration-300">
                  ...
                  <p className="bg-black inline text-white font-semibold opacity-0 group-hover:opacity-100 transition-all">
                    {service.description}
                  </p>
                </div>
              </div>
